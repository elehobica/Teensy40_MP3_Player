...
/*
size_t MyCodecFile::fillReadBuffer(uint8_t *data, size_t dataLeft)
{//TODO: Sync to 512-Byte blocks, if possible
...
{
	if (paused) playing = my_codec_paused;
	else
	playing = my_codec_playing;
	return (playing == my_codec_paused);
}

/** Return the number of bytes currently free in RAM. */
/** from Fat16util.h 2008 by William Greiman**/
int MyAudioCodec::freeRam(void) {
