...
enum my_codec_filetype {my_codec_none, my_codec_file, my_codec_flash, my_codec_serflash};
enum my_codec_playstate {my_codec_stopped, my_codec_playing, my_codec_paused};
...
class MyAudioCodec : public AudioStream, protected MyCodecFile
{
public:
